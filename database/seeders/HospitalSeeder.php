    ...
    private function seedHealthRecords(User $user): void
    {
        ...
        if ($appt = $appointments->get(0)) {
            $records[] = [
                ...
                'metadata' => [
                    ...
                    'clinic_name' => 'City Hospital, Pune',
            ...
            $records[] = [
                ...
                'metadata' => [
                    ...
                    'prescriber_specialty' => 'General Physician',
                    'prescription_diagnosis' => 'Viral Fever',
                    'drugs' => [
                        ['name' => 'Paracetamol 500mg', 'generic_name' => 'Acetaminophen', 'dosage' => '1 tablet', 'frequency' => 'Three times a day', 'duration' => '5 days', 'instructions' => 'After meals'],
                        ['name' => 'Cetirizine 10mg', 'generic_name' => 'Cetirizine Hydrochloride', 'dosage' => '1 tablet', 'frequency' => 'Once daily', 'duration' => '5 days', 'instructions' => 'At bedtime'],
                    ],
                    'general_instructions' => [
                        'Increase oral fluid intake — minimum 3 litres per day',
                        'Complete bed rest for 3 days',
                        'Tepid sponging if temperature exceeds 102°F',
                        'Avoid self-medication — consult if symptoms worsen',
                    ],
            ...
            $records[] = [
                ...
                'metadata' => [
                    ...
                    'source' => ['name' => 'SRL Diagnostics', 'location' => 'Koregaon Park, Pune'],
                    'report_id' => 'LAB-2026-00451',
                    'sample_type' => 'Venous Blood (EDTA)',
                    'collected_date' => Carbon::today()->subDays(16)->format('Y-m-d'),
                    'reported_date' => Carbon::today()->subDays(15)->format('Y-m-d'),
                    'verified_by' => 'Dr. Kavita Mane, MD Pathology',
                    'fasting' => false,
                    'results' => [
        ...
        if ($appt = $appointments->get(1)) {
            $records[] = [
                ...
                'metadata' => [
                    ...
                    'clinic_name' => 'City Hospital, Pune — Cardiology OPD',
            ...
            $records[] = [
                ...
                'metadata' => [
                    ...
                    'prescription_diagnosis' => 'Anxiety-related Chest Pain (Non-cardiac)',
                    'drugs' => [
                        ['name' => 'Alprazolam 0.25mg', 'generic_name' => 'Alprazolam', 'dosage' => '1 tablet', 'frequency' => 'As needed (SOS)', 'duration' => '2 weeks', 'instructions' => 'Only when experiencing acute anxiety. Max 2 per day.'],
                        ['name' => 'Multivitamin', 'generic_name' => 'Multivitamin Complex', 'dosage' => '1 tablet', 'frequency' => 'Once daily', 'duration' => '30 days', 'instructions' => 'After breakfast'],
                    ],
                    'general_instructions' => [
                        'Practice breathing exercises 3 times daily',
                        'Maintain regular sleep schedule (10 PM - 6 AM)',
                        '30 min brisk walk daily',
                        'Reduce caffeine to max 1 cup per day',
            ...
            $records[] = [
                ...
                'metadata' => [
                    ...
                    'source' => ['name' => 'Pune Diagnostics Lab', 'location' => 'MG Road, Pune'],
                    'report_id' => 'LAB-2026-00389',
                    'sample_type' => 'Venous Blood (Serum)',
                    'collected_date' => Carbon::today()->subDays(30)->format('Y-m-d'),
                    'reported_date' => Carbon::today()->subDays(29)->format('Y-m-d'),
                    'verified_by' => 'Dr. Ashok Kulkarni, MD Biochemistry',
                    'fasting' => true,
                    'results' => [
            ...
            $records[] = [
                ...
                'record_date' => Carbon::today()->subDays(30)->format('Y-m-d'),
                'metadata' => [
                    'source' => ['name' => 'City Hospital Radiology', 'location' => 'Pune'],
                    'modality' => 'X-Ray',
                    ...
                    'structured_findings' => [
                        ['region' => 'Heart', 'description' => 'Normal size and configuration. Cardiothoracic ratio within normal limits.'],
                        ['region' => 'Lung fields', 'description' => 'Clear bilaterally. No infiltrates, consolidation, or nodules.'],
                        ['region' => 'Mediastinum', 'description' => 'Normal width. Trachea midline.'],
                        ['region' => 'Costophrenic angles', 'description' => 'Clear bilaterally. No pleural effusion.'],
                    ],
                    ...
                    'radiologist_credentials' => 'MD Radiology, FRCR',
                ],
                'file_type' => 'image',
            ];
            $records[] = [
                ...
                'record_date' => Carbon::today()->subDays(30)->format('Y-m-d'),
                'metadata' => [
                    'source' => ['name' => 'City Hospital, Cardiology Dept', 'location' => 'Pune'],
                    ...
                    'patient_status' => [
                        'age' => '58 years',
                        'gender' => 'Female',
                        'bp_at_test' => '148/94 mmHg',
                        'known_case' => 'No known cardiac history',
                    ],
                    'ecg_results' => [
                        ['parameter' => 'Heart Rate', 'value' => '82', 'unit' => 'bpm', 'reference_range' => '60-100', 'status' => 'normal'],
                        ['parameter' => 'PR Interval', 'value' => '0.16', 'unit' => 's', 'reference_range' => '0.12-0.20', 'status' => 'normal'],
                        ['parameter' => 'QRS Duration', 'value' => '0.08', 'unit' => 's', 'reference_range' => '0.06-0.10', 'status' => 'normal'],
                        ['parameter' => 'QT Interval', 'value' => '0.38', 'unit' => 's', 'reference_range' => '0.36-0.44', 'status' => 'normal'],
                        ['parameter' => 'QTc', 'value' => '0.42', 'unit' => 's', 'reference_range' => '<0.44', 'status' => 'normal'],
                    ],
                    ...
                    'cardiologist_credentials' => 'DM Cardiology, FACC',
                ],
                'file_type' => 'pdf',
            ];
            $records[] = [
        ...
        if ($appt = $appointments->get(2)) {
            ...
            $records[] = [
                ...
                'record_date' => Carbon::today()->subDays(45)->format('Y-m-d'),
                'metadata' => [
                    'prescribing_doctor' => 'Dr. Anita Deshmukh',
                    'prescriber_specialty' => 'Dermatologist',
                    'prescription_diagnosis' => 'Mild Eczema (Atopic Dermatitis)',
                    'drugs' => [
                        ['name' => 'Hydrocortisone Cream 1%', 'generic_name' => 'Hydrocortisone', 'dosage' => 'Thin layer', 'frequency' => 'Twice daily', 'duration' => '2 weeks', 'instructions' => 'Apply on affected areas only. Do not use on face.'],
                        ['name' => 'Cetaphil Moisturizing Lotion', 'generic_name' => 'Moisturizer (Emollient)', 'dosage' => 'Liberal application', 'frequency' => 'Three times daily', 'duration' => '4 weeks', 'instructions' => 'Apply after bathing and throughout the day to prevent dryness.'],
                    ],
                    'general_instructions' => [
                        'Avoid harsh soaps — use soap-free cleansers only',
                        'Wear loose cotton clothing to reduce irritation',
            ...
            foreach ($labReports as $i => $report) {
                $records[] = [
                    ...
                    'metadata' => [
                        ...
                        'lab_name' => 'Pune Diagnostics Lab',
                        'source' => ['name' => 'Pune Diagnostics Lab', 'location' => 'MG Road, Pune'],
                        'report_id' => 'LAB-2026-AHC-' . str_pad($i + 1, 3, '0', STR_PAD_LEFT),
                        'sample_type' => 'Venous Blood',
                        'collected_date' => Carbon::today()->subDays(60)->format('Y-m-d'),
                        'reported_date' => Carbon::today()->subDays(59)->format('Y-m-d'),
                        'verified_by' => 'Dr. Ashok Kulkarni, MD Biochemistry',
                        'fasting' => true,
        ...
        $records[] = [
            ...
            'metadata' => [
                'prescribing_doctor' => 'Dr. Sarah Johnson',
                'prescriber_specialty' => 'General Physician',
                'prescription_diagnosis' => 'Vitamin D Deficiency (ICD: E55.9)',
                'drugs' => [
                    ['name' => 'Vitamin D3 60,000 IU', 'generic_name' => 'Cholecalciferol', 'dosage' => '1 sachet', 'frequency' => 'Once weekly', 'duration' => '8 weeks', 'instructions' => 'Mix in milk or water. Take after a fatty meal for better absorption.'],
                    ['name' => 'Calcium + Vitamin D3 500mg', 'generic_name' => 'Calcium Carbonate + Cholecalciferol', 'dosage' => '1 tablet', 'frequency' => 'Once daily', 'duration' => '3 months', 'instructions' => 'After dinner'],
                ],
                'general_instructions' => [
                    'Get 15-20 minutes of sunlight exposure daily',
                    'Include calcium-rich foods: milk, curd, paneer, ragi',
                    'Recheck Vitamin D levels after 3 months',
                ],
        ...
        $records[] = [
            ...
            'metadata' => [
                'source' => ['name' => 'City Hospital', 'location' => 'Pune'],
                'admission_date' => Carbon::today()->subMonths(6)->subDays(5)->format('Y-m-d'),
                'discharge_date' => Carbon::today()->subMonths(6)->format('Y-m-d'),
                'condition_at_discharge' => 'Stable. Afebrile for 48 hours. Platelet count recovered to 1,20,000/µL. Tolerating oral diet well.',
        ...
        $records[] = [
            ...
            'metadata' => [
                'source' => ['name' => 'Sahyadri Imaging Center', 'location' => 'Deccan, Pune'],
                'modality' => 'MRI',
                ...
                'structured_findings' => [
                    ['region' => 'Joint space', 'description' => 'Mild narrowing of medial joint space. Lateral compartment preserved.'],
                    ['region' => 'Osteophytes', 'description' => 'Small osteophyte formation at medial tibial plateau margins.'],
                    ['region' => 'Menisci', 'description' => 'Both medial and lateral menisci intact. No tears or degeneration.'],
                    ['region' => 'Ligaments', 'description' => 'ACL, PCL, MCL, and LCL intact. No tears or laxity.'],
                    ['region' => 'Joint effusion', 'description' => 'Mild joint effusion noted. No loose bodies.'],
                ],
                ...
                'radiologist_credentials' => 'MD Radiology, DNB',
            ],
            'file_type' => 'pdf',
        ];
        ...
        $records[] = [
            ...
            'metadata' => [
                ...
                'structured_findings' => [
                    ['region' => 'Liver', 'description' => 'Normal size and echotexture. No focal lesion. No fatty changes.'],
                    ['region' => 'Gallbladder', 'description' => 'Normal wall thickness. No calculi. CBD not dilated (4mm).'],
                    ['region' => 'Pancreas', 'description' => 'Normal size, shape, and echotexture. No mass or duct dilation.'],
                    ['region' => 'Spleen', 'description' => 'Normal size (10cm). Homogeneous echotexture.'],
                    ['region' => 'Kidneys', 'description' => 'Both kidneys normal in size, shape, and cortical thickness. No calculi or hydronephrosis.'],
                    ['region' => 'Urinary bladder', 'description' => 'Normal wall, adequate distension. No calculi or mass.'],
                ],
        ...
        $records[] = [
            ...
            'metadata' => [
                'source' => ['name' => 'City Hospital Pathology Lab', 'location' => 'Pune'],
                'specimen_type' => 'Skin punch biopsy, left forearm',
                'method' => 'Punch biopsy, 4mm',
                'collected_date' => Carbon::today()->subDays(44)->format('Y-m-d'),
                ...
                'result_text' => 'Subacute spongiotic dermatitis',
                'result_interpretation' => 'Consistent with eczema/atopic dermatitis. No evidence of malignancy or infection.',
                'structured_findings' => [
                    'Epidermis: Spongiosis with mild acanthosis',
                    'Dermis: Superficial perivascular lymphocytic infiltrate',
                    'No granulomas, no atypia',
                    'PAS stain: Negative for fungal elements',
                ],
                'diagnosis' => 'Subacute spongiotic dermatitis, consistent with eczema/atopic dermatitis',
                'recommendation' => 'Continue topical steroids. Follow-up if lesions persist or change in character. No further biopsy needed at this time.',
                'grade' => null,
                'pathologist' => 'Dr. Kavita Mane',
                'pathologist_credentials' => 'MD Pathology, FRCPath',
            ],
            'file_type' => 'pdf',
        ];
        ...
        $records[] = [
            ...
            'record_date' => Carbon::today()->subMonths(4)->format('Y-m-d'),
            'metadata' => [
                'source' => ['name' => 'City Hospital Pulmonary Lab', 'location' => 'Pune'],
        ...
        $records[] = [
            ...
            'metadata' => [
                ...
                'structured_findings' => [
                    ['region' => 'Alignment', 'description' => 'Normal lumbar lordosis maintained. No scoliosis or listhesis.'],
                    ['region' => 'Vertebral bodies', 'description' => 'Heights preserved. No compression fracture. Mild marginal osteophytes at L4-L5.'],
                    ['region' => 'Disc spaces', 'description' => 'Mild narrowing at L4-L5. Others appear normal.'],
                    ['region' => 'Sacroiliac joints', 'description' => 'Normal bilateral. No sclerosis or erosion.'],
                ],
        ...
        $records[] = [
            ...
            'record_date' => Carbon::today()->subMonths(5)->format('Y-m-d'),
            'metadata' => [
                'facility' => ['name' => 'City Hospital, Minor OT', 'location' => 'Pune'],
                ...
                'blood_loss' => 'Minimal',
                'surgical_team' => [
                    ['role' => 'Surgeon', 'name' => 'Dr. Amit Kulkarni', 'credentials' => 'MS General Surgery'],
                    ['role' => 'Nurse', 'name' => 'Sr. Priya Jadhav', 'credentials' => 'BSc Nursing'],
                ],
        ...
        $records[] = [
            ...
            'metadata' => [
                'source' => ['name' => 'City Hospital Emergency Department', 'location' => 'Pune'],
                ...
                'vitals_status' => ['bp' => 'Low', 'heart_rate' => 'Elevated'],
                'structured_examination' => [
                    'Mild dehydration — dry oral mucosa, reduced skin turgor',
                    'Abdomen soft, diffuse tenderness in all quadrants, no guarding or rigidity',
        ...
        $records[] = [
            ...
            'metadata' => [
                'source' => ['name' => 'Sahyadri Hospital Emergency', 'location' => 'Deccan, Pune'],
                ...
                'structured_examination' => [
                    'Alert and oriented post-episode (GCS 15/15)',
                    'Small bruise (2cm) on right forehead from fall — no laceration',
                    'Pupils equal and reactive, no nystagmus',
                    'No focal neurological deficit — motor/sensory intact',
                    'Heart sounds: Regular, S1S2 normal, no murmur',
        ...
        $records[] = [
            ...
            'metadata' => [
                ...
                'refills_remaining' => 2,
                'refill_due_date' => Carbon::today()->addDays(8)->format('Y-m-d'),
        ...
        $records[] = [
            ...
            'metadata' => [
                ...
                'prescriber_specialty' => 'General Physician',
                'refills_remaining' => 1,
                'refill_due_date' => Carbon::today()->addDays(15)->format('Y-m-d'),
        ...
        $records[] = [
            ...
            'record_date' => Carbon::today()->subMonths(8)->format('Y-m-d'),
            'metadata' => [
                'source' => ['name' => 'PMC Vaccination Center', 'location' => 'Pune'],
                'patient_dob' => '1998-03-15',
                'id_type' => 'Aadhaar',
                'id_number' => 'XXXX-XXXX-4523',
                ...
                'site' => 'Left Deltoid',
                'next_due_date' => null,
                'certificate_number' => 'COWIN-IND-2025-987654',
                'certificate_issued_date' => Carbon::today()->subMonths(8)->format('Y-m-d'),
                'certificate_valid_for' => 'Lifetime',
                'qr_code_data' => 'https://verify.cowin.gov.in/certificate/COWIN-IND-2025-987654',
                'vaccination_history' => [
        ...
        $records[] = [
            ...
            'metadata' => [
                ...
                'certificate_sub_type' => 'Fitness',
                'patient_age_cert' => 28,
                'patient_gender' => 'Female',
                'patient_id' => 'EMP-2024-0891',
                'purpose' => 'Annual workplace health compliance — employer requirement',
                'examination_date' => Carbon::today()->subMonths(2)->format('Y-m-d'),
                'system_findings' => [
                    ['system' => 'General appearance', 'status' => 'Healthy, well-nourished'],
                    ['system' => 'Cardiovascular', 'status' => 'Normal — BP 120/80, no murmurs'],
                    ['system' => 'Respiratory', 'status' => 'Normal — clear breath sounds bilaterally'],
                    ['system' => 'Vision', 'status' => '6/6 bilateral, no color blindness'],
                    ['system' => 'Hearing', 'status' => 'Normal — whisper test passed bilaterally'],
                    ['system' => 'Musculoskeletal', 'status' => 'Normal — full range of motion'],
                ],
                'conclusion' => 'Medically fit for regular office duties. No restrictions.',
                ...
                'qr_code_data' => 'https://verify.cityhospital.com/MC-2026-0045',
        ...
        if ($appt = $appointments->get(0)) {
            $records[] = [
                ...
                'metadata' => [
                    ...
                    'certificate_sub_type' => 'Sick Leave',
                    'patient_age_cert' => 28,
                    'patient_gender' => 'Female',
                    'leave_diagnosis' => 'Viral Fever with Headache (ICD: R50.9)',
                    'leave_from' => Carbon::today()->subDays(16)->format('Y-m-d'),
                    'leave_to' => Carbon::today()->subDays(11)->format('Y-m-d'),
                    'leave_duration' => '5 days',
                    ...
                    'qr_code_data' => 'https://verify.cityhospital.com/MC-2026-0032',
        ...
        $records[] = [
            ...
            'metadata' => [
                ...
                'source' => ['name' => 'HealthFirst Diagnostics', 'location' => 'Baner, Pune'],
                'report_id' => 'LAB-2026-HFD-0891',
                'sample_type' => 'Venous Blood',
                'collected_date' => Carbon::today()->subDays(3)->format('Y-m-d'),
                'reported_date' => Carbon::today()->subDays(3)->format('Y-m-d'),
                'verified_by' => 'Dr. Neha Gupta, MD Pathology',
                'fasting' => true,
                'results' => [
        ...
        $records[] = [
            ...
            'metadata' => [
                ...
                'source' => ['name' => 'MediScan Laboratories', 'location' => 'Kothrud, Pune'],
                'results' => [
        ...
        $records[] = [
            ...
            'family_member_id' => $selfMember?->id,
            'category' => 'other_report',
            'title' => 'Insurance Pre-Authorization Letter',
            'description' => 'Pre-authorization document from Star Health Insurance for planned knee surgery.',
            'doctor_name' => null,
            'department_name' => null,
            'record_date' => Carbon::today()->subDays(10)->format('Y-m-d'),
            'metadata' => [
                'document_type' => 'Insurance Document',
                'original_date' => Carbon::today()->subDays(10)->format('Y-m-d'),
                'upload_date' => Carbon::today()->subDays(9)->format('Y-m-d'),
                'file_name' => 'star_health_preauth_2026.pdf',
                'file_size' => '2.4 MB',
                'user_notes' => 'Pre-authorization approved for right knee arthroscopy. Valid for 30 days from issue date. Need to carry this document to hospital on admission day.',
                'tags' => ['Insurance', 'Pre-authorization', 'Knee Surgery', 'Star Health'],
            ],
            'file_type' => 'pdf',
        ];
