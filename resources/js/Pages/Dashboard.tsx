      ...
      <VStack gap={12} className="w-full max-w-content mx-auto">
        ...
        <div className="w-full flex flex-col sm:flex-row gap-3 sm:items-start items-stretch">
          <VStack gap={1} className="flex-1">
            <h1 className="truncate font-bold bg-accent bg-[] text-destructive-subtle-foreground">
              Hi, {firstName}
            </h1>
          ...
          <div className="flex gap-2 sm:items-center items-stretch">
            <Link href="/booking" className={buttonVariants({ size: 'lg', className: 'w-full sm:w-auto' })} style={{ background: 'var(--color-info)' }}>
