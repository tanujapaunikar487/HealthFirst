...
export default function Dashboard({
  ...
  return (
    <AppLayout user={user}>
      ...
      <div style={{ width: '738px', minHeight: '720px', padding: '40px', display: 'flex', flexDirection: 'column', gap: '48px' }}>
        {/* Page Header */}
        <div style={{ display: 'flex', flexDirection: 'row', width: '738px', height: '68px', gap: '12px', alignItems: 'flex-start' }}>
          {/* Left Section - Text */}
        ...
        {/* Yellow Fever Vaccination Banner */}
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          height: '40px',
          borderRadius: '9999px',
          backgroundColor: step.completed ? '#16A34A' : '#EEF0F3'
        }}
      >
        {step.completed ? (
          <Check className="h-5 w-5" style={{ color: '#FFFFFF', strokeWidth: 2.5 }} />
        ) : (
