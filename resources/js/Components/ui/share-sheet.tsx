...
export function ShareSheet({ open, onOpenChange, title, description, url }: ShareSheetProps) {
        ...
        <Sheet open={open} onOpenChange={onOpenChange}>
            <SheetContent side="right" className="w-full sm:max-w-md">
                <SheetHeader>
                    ...
                    <SheetDescription className="sr-only">Share this appointment</SheetDescription>
                </SheetHeader>
                    ...
                    <div className="rounded-xl border bg-muted/30 p-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div className="min-w-0 flex-1">
                                ...
                                <p className="text-xs text-muted-foreground/70 mt-1 truncate">{url}</p>
                            </div>
                        </div>
                    </div>
