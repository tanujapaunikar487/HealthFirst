  ...
  ({ className, value, onChange, error, disabled, ...props }, ref) => {
    ...
    return (
      <div className={cn('flex items-center', className)}>
        {/* Country Code Badge */}
        <div className={cn(
          'flex h-10 items-center justify-center rounded-l-lg border border-r-0 bg-muted px-3 text-sm font-medium',
        ...
        <input
          ...
          disabled={disabled}
          className={cn(
            'flex h-10 w-full rounded-r-lg border bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground',
